...
public class StringConstant {
    ...
    public  static final String ABOUT_TEXT = "This project is a cryptographic tool that provides functionalities for encryption and hashing. " +
            ...
            "and generate cryptographic hashes.\n\n" +
            "The project aims to help users better understand and utilize cryptographic techniques, especially " +
            "in securing sensitive information and digital communication.\n\n" +
            "Developed as a part of the midterm project for learning cryptography in Java Swing.";
    public static final String GREETING = "<html><div style='text-align: center;'>"
